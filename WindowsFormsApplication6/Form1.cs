...
namespace WindowsFormsApplication6
{
    public partial class Form1 : Form
    {
        ...
        public Form1(string f,string g, string h)
        {
            InitializeComponent();
            str1 = f;
            str2 = g;
            ...
            radioButton2.Text = str2;
            radioButton3.Text = str3;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked == true)
            {
                ...
                else
                {
                    ...
                    textBox1.Text = str1+" bets $" + joe_ob.joe_bet_amount + " on runner " + joe_ob.joe_bet_runner;
                }
            }
            else if (radioButton2.Checked==true)
            {
                ...
                else
                {
                    ...
                    textBox2.Text = str2+" bets $" + bob_ob.bob_bet_amount + " on runner " + bob_ob.bob_bet_runner;
                }
            }
            else if (radioButton3.Checked==true)
            {
                ...
                else
                {
                    ...
                    textBox3.Text = str3+" bets $" + al_ob.al_bet_amount + " on runner " + al_ob.al_bet_runner;
                }
            }
